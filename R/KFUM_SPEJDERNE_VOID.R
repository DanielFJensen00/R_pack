KFUM_SPEJDERNE_VOID <- function(base_size = 11,
                                base_family = "",
  ...
  theme(
    line = element_blank(),
    #element_line(colour = "#1D3C34", linewidth = base_line_size, linetype = 1, lineend = "butt"),
    rect = element_blank(),
    #element_rect(fill = "white", colour = "#1D3C34",linewidth = base_rect_size, linetype = 1),
